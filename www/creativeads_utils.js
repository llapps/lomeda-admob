! function() {
    var t = window.CreativeAds || (window.CreativeAds = {});
    window.cordova && "undefined" != typeof module && (module.exports = t), t.version = "1.0", t.extend = function(t, o) {
        ...
        for (var n = "CreativeAds." == t.substring(0, 7) ? t.substr(7) : t, r = window.CreativeAds, i = n.split("."), s = r, a = 0; a < i.length; a++) {
            var p = i[a];
    ...
    }, console.log("Created namespace: CreativeAds")
}();