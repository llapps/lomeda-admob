!function() {
    !window.CreativeAds && window.cordova && "undefined" != typeof require && cordova.require("creativeads-admob.CreativeAdsUtils");
    var e = window.CreativeAds;
    e.define("AdMob", function(i) {
        "use strict";
        i.BannerLayout = {
