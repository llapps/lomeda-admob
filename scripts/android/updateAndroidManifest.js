(function() {
  ...
  function writePreferences(context, preferences) {
    ...
    // update manifest
    manifest.file = updateCreativeAdsMetaData(manifest.file, preferences);
  ...
  function updateCreativeAdsMetaData(manifest, preferences) {
  ...
  // remove previous CreativeAds related <meta-data> and <receiver> based on android:name
  ...
  // get the main <activity> because CreativeAds Intent Filters must be in the main Launch Activity
